...
document.addEventListener('DOMContentLoaded', function(event) {
	...
	function changeBg(item, checkall) {
		...
		if (checkall.checked) {
			var published = item.classList.contains('published');
			var unpublished = item.classList.contains('unpublished');
			item.querySelectorAll('td').forEach (function(td) {
				td.classList.add('row-selected');
				document.body.classList.add('table-row-selected');
				if (published) {
					document.body.classList.add('table-row-published');
				}
				if (unpublished) {
					document.body.classList.add('table-row-unpublished');
				}
			...
			item.querySelectorAll('td').forEach (function(td) {
				...
				document.body.classList.remove('table-row-selected');
			});
		}
	}
