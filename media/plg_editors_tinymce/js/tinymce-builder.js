...
(function (Joomla, window) {
  ...
  var TinyMCEBuilder = function TinyMCEBuilder(container, options) {
    var $sourceMenu = container.querySelector('.timymce-builder-menu.source');
    var $sourceToolbar = container.querySelector('.timymce-builder-toolbar.source');
    var $targetMenu = container.querySelectorAll('.timymce-builder-menu.target');
    var $targetToolbar = container.querySelectorAll('.timymce-builder-toolbar.target');
    /**
