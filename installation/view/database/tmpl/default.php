	...
	<div class="row">
		<div class="col-md-11 col-lg-12 container">
			<div class="form-group row align-items-center">
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getLabel('db_type'); ?></div>
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getInput('db_type'); ?></div>
				<div class="col-md-1">
			...
			<div class="form-group row align-items-center">
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getLabel('db_host'); ?></div>
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getInput('db_host'); ?></div>
				<div class="col-md-1">
			...
			<div class="form-group row align-items-center">
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getLabel('db_user'); ?></div>
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getInput('db_user'); ?></div>
				<div class="col-md-1">
			...
			<div class="form-group row align-items-center">
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getLabel('db_pass'); ?></div>
				<?php // Disables autocomplete ?> <input type="password" style="display:none">
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getInput('db_pass'); ?></div>
				<div class="col-md-1">
			...
			<div class="form-group row align-items-center">
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getLabel('db_name'); ?></div>
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getInput('db_name'); ?></div>
				<div class="col-md-1">
			...
			<div class="form-group row align-items-center">
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getLabel('db_prefix'); ?></div>
				<div class="col-md-8 offset-md-2"><?php echo $this->form->getInput('db_prefix'); ?></div>
				<div class="col-md-1">
